...
function getCart() {
  var cart = Cookies.get('cart'); // 以下是寫法1，還是太長了
  // if (!cart){
  //     cart = {}
  // }else{
  ...
  if (addToCartBtn) {
    addToCartBtn.addEventListener('click', function () {
      ...
      if (quantityInput) {
        ...
        alertProductQuantity(productId); // var quantity = parseInt(Cookies.get('quantity')) || 0
...
/***/ "./resources/css/app_calendar.scss":
/*!*****************************************!*\
  !*** ./resources/css/app_calendar.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["css/app_calendar","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app_calendar","css/app"], () => (__webpack_require__("./resources/css/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app_calendar","css/app"], () => (__webpack_require__("./resources/css/app_calendar.scss")))
